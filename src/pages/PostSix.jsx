...
function WomenHealth({ language }) {
  ...
  const content = {
    AR: {
      ...
      description: `يضم مركز صحة المرأة في مستشفى تخصصي نجران العديد من الاستشاريين الجراحين والأخصائيين في مجال أمراض وجراحات النساء والولادة وتخصصاتها الدقيقة، حيث يتوفر لهم العديد من أحدث أجهزة التشخيص والعلاج وغرف العمليات المتطورة وكذلك وحدة خاصة للطوارئ النسائية والولادة. يحتوي القسم على العديد من الوحدات المخصصة لصحة المرأة.
  
      فريقنا الطبي:
      • استشاريون متخصصون في طب النساء والولادة
      • أخصائيون معتمدون
      • طاقم تمريض مؤهل
  
      التقنيات المستخدمة:
      • أحدث أجهزة فحص وتشخيص أمراض النساء
      • معدات جراحية متطورة
      • تقنيات الليزر الحديثة`,
      services: [
        "استشارات في أمراض النساء والولادة",
        "جراحة أمراض النساء المتقدمة",
        "علاج العقم والتخصيب المساعد",
        "علاج اضطرابات الدورة الشهرية",
        "استشارات ما قبل الحمل والولادة",
        "تشخيص وعلاج سرطان الثدي وعنق الرحم"
      ],
    ...
    EN: {
      ...
      description: `The Women's Health Center at Najran Specialized Hospital includes many consultants, surgeons, and specialists in the field of obstetrics and gynecology and their subspecialties. The center is equipped with the latest diagnostic and treatment devices and advanced operating rooms, as well as a dedicated unit for obstetrics and gynecology emergencies. The department contains many units focused on women's health.
  
      Our Medical Team:
      • Obstetrics and Gynecology Consultants
      • Certified Specialists
      • Qualified Nursing Staff
  
      Technologies Used:
      • Latest Women's Health Diagnostic Devices
      ...
      services: [
        ...
        "Pre-pregnancy and Prenatal Consultations",
