...
function InternalMedicine({ language }) {
  ...
  const content = {
    AR: {
      ...
      فريقنا الطبي:
      • استشاريون متخصصون في الطب الباطني  
      • أخصائيو باطنة معتمدون
      • طاقم تمريض مؤهل
  
      التقنيات المستخدمة:
      • أحدث أجهزة فحص وتشخيص أمراض الباطنة
      • معدات جراحية متطورة
      • التقنيات الحديثة`,
      services: [
        "تشخيص وعلاج الأمراض المزمنة",
        "علاج أمراض القلب والشرايين",
        "إدارة السكري وضغط الدم",
    ...
    EN: {
      ...
      Technologies Used:
      • Latest Internal Medicine Diagnostic Devices
      • Advanced Surgical Equipment
      • Modern Technologies`,
      services: [
        "Chronic Disease Diagnosis and Treatment",
        "Cardiovascular and Arterial Disease Treatment",
